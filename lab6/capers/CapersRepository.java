...
public class CapersRepository {
    ...
    public static void setupPersistence() {
        // TODO
        //File storeDogs = new File('Dogs');
        //File storeBirthday = new File('DogBirthday');
        //File storeStory = new File("Story.txt");
        //File StoryFile = join( Dog.DOG_FOLDER, "stories");
    ...
    public static void writeStory(String text) {
        // TODO
        File story = Utils.join(CapersRepository.CAPERS_FOLDER, "story");
        if( story.exists() ){
